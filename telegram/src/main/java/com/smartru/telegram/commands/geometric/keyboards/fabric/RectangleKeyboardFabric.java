...
public class RectangleKeyboardFabric extends ShapeKeyboardFabric{

    @Override
    public ReplyKeyboard getShapeKeyboard() {
        InlineKeyboardMarkup keyboard = new InlineKeyboardMarkup();
        final String callbackPrefix = "/solve "+ Shape.Type.RECTANGLE +" ";
    ...
    public ReplyKeyboard getShapeParameterKeyboard(Desired desired) {
        InlineKeyboardMarkup keyboard = new InlineKeyboardMarkup();
        String callbackPrefix = "/solve "+ Shape.Type.RECTANGLE +" "+desired+" ";
